 ...
 * determines possible answers from the @FactProvider. The answers are sorted by score, highest first.
 *
...
public interface FactMatcher {
    ...
    /**
    Get matching answers from the @FactProvider for a question expressed as @List<NerdleFact>
     */
