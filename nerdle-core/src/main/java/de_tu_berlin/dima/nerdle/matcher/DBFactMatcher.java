 ...
 *
 */
public class DBFactMatcher implements FactMatcher {

    @Override
    public List<NerdleFact> match(FactProvider factProvider, NerdleFact questionFact, NerdleArg searchArg) {

        if (!(factProvider instanceof DBFactProvider)) {
            throw new IllegalArgumentException("Please use a DBFactProvider.");
        }
