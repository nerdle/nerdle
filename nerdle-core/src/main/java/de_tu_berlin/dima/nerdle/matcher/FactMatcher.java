...
public interface FactMatcher {
    List<NerdleFact> match(FactProvider factProvider, NerdleFact questionFact, NerdleArg searchArg);

    List<NerdleFact> explore(FactProvider factProvider, NerdlePredicate questionPredicate);
}