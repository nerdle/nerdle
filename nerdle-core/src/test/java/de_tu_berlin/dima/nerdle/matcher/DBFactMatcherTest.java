...
public class DBFactMatcherTest {

    private static DBFactProvider dbFactProvider;
    private static DBFactMatcher dbFactmatcher;
    ...
    public static void init() {
        ...
        dbFactmatcher = new DBFactMatcher();
    }
    ...
    public void testExact() {
        ...
        List<NerdleFact> matchedFacts = dbFactmatcher.match(dbFactProvider, questionFact, new NerdleArg("", "", "A1", "nsubj"));
